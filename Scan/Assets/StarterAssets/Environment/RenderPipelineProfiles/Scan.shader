...
Shader "test/Scan"
{
	Properties
	{
		...
		_width("width", Range( -1 , 1)) = 0.1
		[ASEEnd]_yoffset("yoffset", Range( 0 , 1)) = 0.2
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_11_0 = distance( WorldPosition , _Vector0 );
				float smoothstepResult18 = smoothstep( 0.5 , 0.0 , ( temp_output_11_0 > _dis ? 1.0 : distance( temp_output_11_0 , _dis ) ));
				float temp_output_1_0_g4 = WorldPosition.x;
				float temp_output_1_0_g5 = ( WorldPosition.y + _yoffset );
				float temp_output_1_0_g6 = WorldPosition.z;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = _BaseColor.rgb;
				float Alpha = ( smoothstepResult18 + ( temp_output_11_0 < _dis ? max( max( step( ( ( abs( ( ( temp_output_1_0_g4 - floor( ( temp_output_1_0_g4 + 0.5 ) ) ) * 2 ) ) * 2 ) - 1.0 ) , _width ) , step( ( ( abs( ( ( temp_output_1_0_g5 - floor( ( temp_output_1_0_g5 + 0.5 ) ) ) * 2 ) ) * 2 ) - 1.0 ) , _width ) ) , step( ( ( abs( ( ( temp_output_1_0_g6 - floor( ( temp_output_1_0_g6 + 0.5 ) ) ) * 2 ) ) * 2 ) - 1.0 ) , _width ) ) : 0.0 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_11_0 = distance( ase_worldPos , _Vector0 );
				float smoothstepResult18 = smoothstep( 0.5 , 0.0 , ( temp_output_11_0 > _dis ? 1.0 : distance( temp_output_11_0 , _dis ) ));
				float temp_output_1_0_g4 = ase_worldPos.x;
				float temp_output_1_0_g5 = ( ase_worldPos.y + _yoffset );
				float temp_output_1_0_g6 = ase_worldPos.z;
				

				surfaceDescription.Alpha = ( smoothstepResult18 + ( temp_output_11_0 < _dis ? max( max( step( ( ( abs( ( ( temp_output_1_0_g4 - floor( ( temp_output_1_0_g4 + 0.5 ) ) ) * 2 ) ) * 2 ) - 1.0 ) , _width ) , step( ( ( abs( ( ( temp_output_1_0_g5 - floor( ( temp_output_1_0_g5 + 0.5 ) ) ) * 2 ) ) * 2 ) - 1.0 ) , _width ) ) , step( ( ( abs( ( ( temp_output_1_0_g6 - floor( ( temp_output_1_0_g6 + 0.5 ) ) ) * 2 ) ) * 2 ) - 1.0 ) , _width ) ) : 0.0 ) );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;222,-10;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;test/Scan;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638141121287068464;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.Compare;17;-667.1672,-111.3709;Inherit;False;2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;10;-1790.189,-150.6826;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;16;-1767.189,30.31753;Inherit;False;Property;_Vector0;Vector 0;2;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DistanceOpNode;11;-1512.189,-42.68243;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-1144.639,157.804;Inherit;False;Property;_dis;dis;1;0;Create;True;0;0;0;False;0;False;-0.5;-0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DistanceOpNode;12;-859.5392,93.20395;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;5.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;18;-371.7142,-68.11891;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;14;-133.5844,-351.4659;Inherit;False;Property;_BaseColor;BaseColor;0;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,3.262745,4,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;26;18.90479,62.41539;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;29;-1376.089,518.8313;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;31;-1375.09,636.8314;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;22;-1381.611,387.1418;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;32;-1149.566,484.5213;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;33;-973.5659,536.5212;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;38;-2018.003,634.0673;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-2361.479,669.5132;Inherit;False;Property;_yoffset;yoffset;4;0;Create;True;0;0;0;False;0;False;0.2;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;20;-2589.048,439.7147;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;37;-1912.152,286.7946;Inherit;False;Property;_width;width;3;0;Create;True;0;0;0;False;0;False;0.1;0.1;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;34;-1860.583,446.5254;Inherit;False;Triangle Wave;-1;;4;51ec3c8d117f3ec4fa3742c3e00d535b;0;1;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;35;-1859.583,517.5251;Inherit;False;Triangle Wave;-1;;5;51ec3c8d117f3ec4fa3742c3e00d535b;0;1;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;36;-1862.583,595.5251;Inherit;False;Triangle Wave;-1;;6;51ec3c8d117f3ec4fa3742c3e00d535b;0;1;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;40;-1236.599,291.3642;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Compare;19;-504.3431,285.1421;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
